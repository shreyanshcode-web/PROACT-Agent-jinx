...
class ChaosBloomPrompt(BasePrompt):
    """Prompt provider for the *chaos_bloom* prompt.
    ...
    enables future templating or dynamic behaviour while keeping the
    registration API compatible.
    """
    ...
    def load(self) -> str:
        ...
        return (
            ...
            "Agility and clarity from Google.\\n\\n"
            ...
            "Let it be worthy of Google review and an Amazon production deploy.\\n\\n"
            "You respond with:\\n\\n"
...
register_prompt("chaos_bloom", lambda: ChaosBloomPrompt().load())
